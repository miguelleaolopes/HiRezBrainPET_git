...
set iteration_2=-it 20:25
set iteration_3=-it 25:20
set iteration_4=-it 50:10
set iteration_5=-it 100:5
set iteration_6=-it 250:2
set iteration_7=-it 500:1
...
@REM echo ==================================================================================
@REM echo Reconstruction is going on. Should take several minutes depending on the hardware.
@REM echo ==================================================================================
...
echo ==================================================================================
echo Reconstruction with CASToR_Derenzo_all_Geom_rsmall_z2s_df in output rsmall_z2s\vs015_MLEM_jos_ittest\3test
echo ==================================================================================
%mpi_stuff% %recon% %verbose% %datafile2% %output_3% %iteration_3% %voxels_number_015% %voxels_size_015% %offset% %projector% %psf_3% %thread% %last_it% %stats_true% %out_flip% %optimizer_MLEM% %sens%
...
@REM echo ==================================================================================
@REM %mpi_stuff% %recon% %verbose% %datafile2% %output_6% %iteration_6% %voxels_number_015% %voxels_size_015% %offset% %projector% %psf_3% %thread% %last_it% %stats_true% %out_flip% %optimizer_MLEM% %sens%
