...
@REM set output_2=-dout ..\..\Results\rsmall_orig\voxsize02_MLEM_jos_gauss05_3sig\1test
@REM set output_3=-dout ..\..\Results\rsmall_orig\voxsize02_DEPIERRO95_jos_gauss05_3sig\1test

@REM set sens=-sens ..\..\Results\rsmall_orig\voxsize02_MLEM_jos_gauss05_3sig\1test_sensitivity.hdr
