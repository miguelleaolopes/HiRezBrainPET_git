...
set output2_stats=-dout .\..\..\Results\rsmall_z2s\vs02_MLEM_jos_gauss05_3sig\1test_stats
set output_2_pnl1=-dout .\..\..\Results\rsmall_z2s\vs02_DEPIERRO95_MRF_jos_gauss05_3sig\1test
set output_2_pnl2=-dout .\..\..\Results\rsmall_z2s\vs02_OSL_MRP_jos_gauss05_3sig\1test
set output_2_pnl3=-dout .\..\..\Results\rsmall_z2s\vs02_OSL_MRF_jos_gauss05_3sig\1test
set output_2_2=-dout .\..\..\Results\rsmall_z2s\vs02_MLEM_jos_gauss05_3sig\2test
set output_2_3=-dout .\..\..\Results\rsmall_z2s\vs02_MLEM_jos_gauss05_3sig\3test
set output_2_4=-dout .\..\..\Results\rsmall_z2s\vs02_MLEM_jos_gauss05_3sig\4test
set output_2_5=-dout .\..\..\Results\rsmall_z2s\vs02_MLEM_jos_gauss05_3sig\5test

@REM set output_3=-dout .\..\..\Results\rsmall_orig\vs02_DEPIERRO95_jos_gauss05_3sig\1test

set sens=-sens .\..\..\Results\rsmall_z2s\vs02_MLEM_jos_gauss05_3sig\1test\1test_sensitivity.hdr
...
echo ==================================================================================
echo Reconstruction with CASToR_Derenzo_all_Geom_rsmall_z2s_df in output rsmall_z2s\vs02_MLEM_jos_gauss05_3sig\1test_stats
echo ==================================================================================
...
echo ==================================================================================
echo Reconstruction with CASToR_Derenzo_all_Geom_rsmall_z2s_df in output rsmall_z2s\vs02_DEPIERRO95_MRF_jos_gauss05_3sig\1test
echo ==================================================================================
...
echo ==================================================================================
echo Reconstruction with CASToR_Derenzo_all_Geom_rsmall_z2s_df in output rsmall_z2s\vs02_OSL_MRP_jos_gauss05_3sig\1test
echo ==================================================================================
...
echo ==================================================================================
echo Reconstruction with CASToR_Derenzo_all_Geom_rsmall_z2s_df in output rsmall_z2s\vs02_OSL_MRF_jos_gauss05_3sig\1test
echo ==================================================================================
...
echo ==================================================================================
echo Reconstruction with CASToR_Derenzo_all_Geom_rsmall_z2s_df in output rsmall_z2s\vs02_MLEM_jos_gauss05_3sig\2test - psf_2 - 1,1,3
echo ==================================================================================
...
echo ==================================================================================
echo Reconstruction with CASToR_Derenzo_all_Geom_rsmall_z2s_df in output rsmall_z2s\vs02_MLEM_jos_gauss05_3sig\3test - psf_3 - 0.2,0.2,3
echo ==================================================================================
...
echo ==================================================================================
echo Reconstruction with CASToR_Derenzo_all_Geom_rsmall_z2s_df in output rsmall_z2s\vs02_MLEM_jos_gauss05_3sig\4test - psf_4 - 0.5,0.5,1.5
echo ==================================================================================
...
echo ==================================================================================
echo Reconstruction with CASToR_Derenzo_all_Geom_rsmall_z2s_df in output rsmall_z2s\vs02_MLEM_jos_gauss05_3sig\5test - no sens - psf_2
echo ==================================================================================
