...
@REM DONE
@REM echo ==================================================================================
@REM echo Reconstruction with CASToR_Derenzo_all_Geom_rsmall_z2s_df in output rsmall_z2s\vs02_D95_MRF_b05_jos_g1_3s\1test_rs
@REM echo ==================================================================================
@REM %mpi_stuff% %recon% %verbose% %datafile2% %output_2_pnl1% %iteration% %voxels_number% %voxels_size% %offset% %projector% %psf% %thread% %post% %last_it% %out_flip% %stats_true% %optimizer_D95% %penalty_MRF% %penalty_strength_05% %sens%

@REM echo ==================================================================================
@REM echo Reconstruction with CASToR_Derenzo_all_Geom_rsmall_z2s_df in output rsmall_z2s\vs02_D95_MRF_b05_jos_g1_3s\1test
@REM echo ==================================================================================
@REM %mpi_stuff% %recon% %verbose% %datafile2% %output_2_pnl2% %iteration% %voxels_number% %voxels_size% %offset% %projector% %psf% %thread% %post% %last_it% %out_flip% %stats_true% %optimizer_D95% %penalty_MRF% %penalty_strength_05%

@REM echo ==================================================================================
@REM echo Reconstruction with CASToR_Derenzo_all_Geom_rsmall_z2s_df in output rsmall_z2s\vs02_D95_MRF_b01_jos_g1_3s\1test_rs
@REM echo ==================================================================================
@REM %mpi_stuff% %recon% %verbose% %datafile2% %output_2_pnl3% %iteration% %voxels_number% %voxels_size% %offset% %projector% %psf% %thread% %post% %last_it% %out_flip% %stats_true% %optimizer_D95% %penalty_MRF% %penalty_strength_01% %sens_2%

@REM echo ==================================================================================
@REM echo Reconstruction with CASToR_Derenzo_all_Geom_rsmall_z2s_df in output rsmall_z2s\vs02_D95_MRF_b01_jos_g1_3s\1test
@REM echo ==================================================================================
@REM %mpi_stuff% %recon% %verbose% %datafile2% %output_2_pnl4% %iteration% %voxels_number% %voxels_size% %offset% %projector% %psf% %thread% %post% %last_it% %out_flip% %stats_true% %optimizer_D95% %penalty_MRF% %penalty_strength_01%

@REM echo ==================================================================================
@REM echo Reconstruction with CASToR_Derenzo_all_Geom_rsmall_z2s_df in output rsmall_z2s\vs02_OSL_MRP_b05_jos_g1_3s\1test
@REM echo ==================================================================================
@REM %mpi_stuff% %recon% %verbose% %datafile2% %output_2_pnl5% %iteration% %voxels_number% %voxels_size% %offset% %projector% %psf% %thread% %post% %last_it% %out_flip% %stats_true% %optimizer_OSL% %penalty_MRP% %penalty_strength_05%

@REM echo ==================================================================================
@REM echo Reconstruction with CASToR_Derenzo_all_Geom_rsmall_z2s_df in output rsmall_z2s\vs02_OSL_MRP_b01_jos_g1_3s\1test
@REM echo ==================================================================================
@REM %mpi_stuff% %recon% %verbose% %datafile2% %output_2_pnl6% %iteration% %voxels_number% %voxels_size% %offset% %projector% %psf% %thread% %post% %last_it% %out_flip% %stats_true% %optimizer_OSL% %penalty_MRP% %penalty_strength_01%

@REM echo ==================================================================================
@REM echo Reconstruction with CASToR_Derenzo_all_Geom_rsmall_z2s_df in output rsmall_z2s\vs02_MLEM_jos_g1_3s\3test_rs
@REM echo ==================================================================================
@REM %mpi_stuff% %recon% %verbose% %datafile2% %output_2_3% %iteration_2% %voxels_number% %voxels_size% %offset% %projector% %psf% %thread% %post% %last_it% %out_flip% %stats_true% %optimizer% %sens%

@REM echo ==================================================================================
@REM echo Reconstruction with CASToR_Derenzo_all_Geom_rsmall_z2s_df in output rsmall_z2s\vs02_MLEM_jos_g1_3s\4test_rs
@REM echo ==================================================================================
@REM %mpi_stuff% %recon% %verbose% %datafile2% %output_2_4% %iteration_3% %voxels_number% %voxels_size% %offset% %projector% %psf% %thread% %post% %last_it% %out_flip% %stats_true% %optimizer% %sens%
