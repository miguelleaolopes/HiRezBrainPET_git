...
set output1=-dout .\..\..\Results\rmid_z4s\vs02_MLEM_jos_gauss1_3sig\1test
set output2=-dout .\..\..\Results\rmid_z2s\vs02_MLEM_jos_gauss1_3sig\1test
set output3=-dout .\..\..\Results\rsmall_big\vs02_MLEM_jos_gauss1_3sig\1test
...
echo ==================================================================================
echo Reconstruction with CASToR_Derenzo_all_Geom_rbig_z2s_df in output rbig_z2s\vs02_MLEM_jos_gauss05_3sig\1test
echo ==================================================================================
%mpi_stuff% %recon% %verbose% %datafile9% %output9% %sens% %iteration% %voxels_number% %voxels_size% %offset_big% %optimizer% %projector% %psf% %thread% %post% %last_it% %out_flip%

echo ==================================================================================
echo Reconstruction with CASToR_Derenzo_all_Geom_rmid_big_z4s_df in output rmid_z4s\vs02_MLEM_jos_gauss1_3sig\1test
echo ==================================================================================
%mpi_stuff% %recon% %verbose% %datafile6% %output1% %sens% %iteration% %voxels_number% %voxels_size% %offset_mid% %optimizer% %projector% %psf_2% %thread% %post% %last_it% %out_flip%

echo ==================================================================================
echo Reconstruction with CASToR_Derenzo_all_Geom_rmid_z2s_df in output rmid_z2s\vs02_MLEM_jos_gauss1_3sig\1test
echo ==================================================================================
%mpi_stuff% %recon% %verbose% %datafile5% %output2% %sens% %iteration% %voxels_number% %voxels_size% %offset_mid% %optimizer% %projector% %psf_2% %thread% %post% %last_it% %out_flip%

echo ==================================================================================
echo Reconstruction with CASToR_Derenzo_all_Geom_rsmall_big_df in output rsmall_big\vs02_MLEM_jos_gauss1_3sig\1test
echo ==================================================================================
%mpi_stuff% %recon% %verbose% %datafile3% %output3% %sens% %iteration% %voxels_number% %voxels_size% %offset% %optimizer% %projector% %psf_2% %thread% %post% %last_it% %out_flip%
