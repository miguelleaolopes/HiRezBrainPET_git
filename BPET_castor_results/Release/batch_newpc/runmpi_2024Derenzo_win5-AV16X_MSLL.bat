...
set psf_6=-conv gaussian,1.,0.7,3::psf
...
%mpi_stuff% %recon% %verbose% %datafile% %output_2_01% %iteration% %voxels_number% %voxels_size% %offset% %projector_sid% %psf% %thread% %post% %last_it% %out_flip% %stats_true% %optimizer%

%mpi_stuff% %recon% %verbose% %datafile% %output_2_02% %iteration% %voxels_number% %voxels_size% %offset% %projector_dri% %psf% %thread% %post% %last_it% %out_flip% %stats_true% %optimizer%

%mpi_stuff% %recon% %verbose% %datafile% %output_2_03% %iteration% %voxels_number% %voxels_size% %offset% %projector_inc% %psf% %thread% %post% %last_it% %out_flip% %stats_true% %optimizer%


%mpi_stuff% %recon% %verbose% %datafile% %output_3_02% %iteration% %voxels_number% %voxels_size% %offset% %projector_dri% %psf% %thread% %post_2% %last_it% %out_flip% %stats_true% %optimizer%

%mpi_stuff% %recon% %verbose% %datafile% %output_4_02% %iteration% %voxels_number% %voxels_size% %offset% %projector_dri% %psf_2% %thread% %last_it% %out_flip% %stats_true% %optimizer%

%mpi_stuff% %recon% %verbose% %datafile% %output_5_02% %iteration% %voxels_number% %voxels_size% %offset% %projector_dri% %psf_3% %thread% %last_it% %out_flip% %stats_true% %optimizer%

%mpi_stuff% %recon% %verbose% %datafile% %output_6_02% %iteration% %voxels_number% %voxels_size% %offset% %projector_dri% %psf_4% %thread% %last_it% %out_flip% %stats_true% %optimizer%

%mpi_stuff% %recon% %verbose% %datafile% %output_7_02% %iteration% %voxels_number% %voxels_size% %offset% %projector_dri% %psf_5% %thread% %last_it% %out_flip% %stats_true% %optimizer%

%mpi_stuff% %recon% %verbose% %datafile% %output_8_02% %iteration% %voxels_number% %voxels_size% %offset% %projector_dri% %psf_6% %thread% %last_it% %out_flip% %stats_true% %optimizer%
