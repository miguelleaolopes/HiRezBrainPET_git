...
class BatchScriptGenerator(tk.Tk):
    ...
    def set_initial_values(self):
        ...
        self.main_program_path_var.set(r"..\..\Release\castor-recon.exe")
        ...
        self.voxel_number_var.set("0.15,0.15,0.4")
        self.voxel_size_var.set("200,200,50")
        self.fov_size_var.set("40,40,20")
        self.offset_var.set("0,-45,-8")
        self.voxel_size_x_var.set(0.15)
        self.voxel_size_y_var.set(0.15)
        ...
        for i in range(self.convolution_num_var.get()):
            ...
            value_var.set("gaussian,1.2,0.02,3::psf")  # Set initial value
            value_x_var = tk.DoubleVar()
            value_x_var.set(1.2)  # Set initial value
            value_y_var = tk.DoubleVar()
            value_y_var.set(0.02)  # Set initial value
    ...
    def create_menu(self):
        ...
        self.menubar.add_command(label="Open from file", command=self.open_from_file)
