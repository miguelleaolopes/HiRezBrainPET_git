...
echo ==================================================================================
echo Reconstruction with CASToR_Derenzo_all_Geom_rsmall_z2s_df in output rsmall_z2s\vs015_opts_dri\OSL_P\b01
echo ==================================================================================
%mpi_stuff% %recon% %verbose% %datafile2% %output_3_01% %iteration_8% %voxels_number_015% %voxels_size_015% %offset% %projector_dri% %psf_3% %thread% %stats_true% %out_flip% %optimizer_OSL% %penalty_MRP% %penalty_strength_01% %sensb1%

echo ==================================================================================
echo Reconstruction with CASToR_Derenzo_all_Geom_rsmall_z2s_df in output rsmall_z2s\vs015_opts_dri\OSL_P\b05
echo ==================================================================================
%mpi_stuff% %recon% %verbose% %datafile2% %output_3_05% %iteration_8% %voxels_number_015% %voxels_size_015% %offset% %projector_dri% %psf_3% %thread% %stats_true% %out_flip% %optimizer_OSL% %penalty_MRP% %penalty_strength_05% %sensb1%

echo ==================================================================================
echo Reconstruction with CASToR_Derenzo_all_Geom_rsmall_z2s_df in output rsmall_z2s\vs015_opts_dri\OSL_P\b10
echo ==================================================================================
%mpi_stuff% %recon% %verbose% %datafile2% %output_3_10% %iteration_8% %voxels_number_015% %voxels_size_015% %offset% %projector_dri% %psf_3% %thread% %stats_true% %out_flip% %optimizer_OSL% %penalty_MRP% %penalty_strength_10% %sensb1%

echo ==================================================================================
echo Reconstruction with CASToR_Derenzo_all_Geom_rsmall_z2s_df in output rsmall_z2s\vs015_opts_dri\OSL_P\b100
echo ==================================================================================
%mpi_stuff% %recon% %verbose% %datafile2% %output_3_100% %iteration_8% %voxels_number_015% %voxels_size_015% %offset% %projector_dri% %psf_3% %thread% %stats_true% %out_flip% %optimizer_OSL% %penalty_MRP% %penalty_strength_100% %sensb1%
